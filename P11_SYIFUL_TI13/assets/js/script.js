...
//     if (pilihanUser == 'Rock' && pilihanComputer.innerHTML == 'Scissor') {
//         alert('YOU WIN');
//     }
//     else if (pilihanUser == 'Papper' && pilihanComputer.innerHTML == 'Rock') {
//         alert('YOU WIN');
//     }
//     else if (pilihanUser == 'Scissor' && pilihanComputer.innerHTML == 'Papper') {
//         alert('YOU WIN');
//     }

//     // jika komputer yang menag
//     if (pilihanUser == 'Rock' && pilihanComputer.innerHTML == 'Papper') {
//         alert('COMPUTER WIN');
//     }
//     else if (pilihanUser == 'Papper' && pilihanComputer.innerHTML == 'Scissor') {
//         alert('COMPUTER WIN');
//     }
//     else if (pilihanUser == 'Scissor' && pilihanComputer.innerHTML == 'Rock') {
//         alert('COMPUTER WIN');
//     }
// }
